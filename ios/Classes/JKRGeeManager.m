...
- (void)gtCaptcha:(GT3CaptchaManager *)manager didReceiveCaptchaCode:(NSString *)code result:(NSDictionary *)result message:(NSString *)message {
    // Customize api1, when you don’t customize api2, you don’t need to intercept here
    if (self.customRegisterAPI && !self.customSecondaryValidate) {
        return;
    }
    // You don’t need to intercept here when you don’t customize
    if (!self.customRegisterAPI && !self.customSecondaryValidate) {
        return;
    }
    // When you don’t customize api1, you need to intercept here when you customize api2, and you also need to intercept when you customize everything
